...
async function printBalances(addresses) {
  ...
  for (const address of addresses) {
    if (idx === 0) {
      console.log(`Address Owner balance: `, await getBalance(address));
    } else if (idx === 1) {
      console.log(`Address Contract balance: `, await getBalance(address));
    } else {
      console.log(`Address Tipper ${idx} balance: `, await getBalance(address));
    }
    idx++;
  }
}
